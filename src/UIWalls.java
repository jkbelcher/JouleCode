...
/**
 * Example of a custom 3d UI component. This draws a box around our custom
 * matrix model.
 */
...
public class UIWalls extends UI3dComponent {
    ...
    private final float WALL_MARGIN = 2 * JouleCode.FEET;
    ...
    public UIWalls(LXModel tModel) {
        ...
        WALL_THICKNESS = 1 * JouleCode.INCHES;
    }
