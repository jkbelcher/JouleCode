...
public class LEDScapeDatagram extends LXDatagram implements OPCConstants {
	  ...
	  public LEDScapeDatagram(int NumberOfChannels, int LEDsPerChannel, AbstractMap<Integer,Integer> indicesMapped) {
	    ...
	    //PApplet.println(this.packetData[INDEX_DATA_LEN_MSB], (this.NumberOfChannels * this.LEDsPerChannel)*3/256);
	    this.buffer[INDEX_DATA_LEN_LSB] = (byte)(dataLength & 0xFF);
	    //this.packetData[INDEX_DATA_LEN_LSB] = (byte)((this.NumberOfChannels * this.LEDsPerChannel)*3%256);
	    //PApplet.println(this.packetData[INDEX_DATA_LEN_LSB], (this.NumberOfChannels * this.LEDsPerChannel)*3%256, dataLength & 0xFF, ((this.NumberOfChannels * this.LEDsPerChannel)*3%256) & 0xFF);
