...
//
// The base class LXAbstractFixture assumes that pixels are added in the exact physical order as the structure.
...
public abstract class LXAbstractFixtureMapped extends LXAbstractFixture {
