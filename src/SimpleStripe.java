...
public class SimpleStripe extends LXPattern {
    ...
    public final CompoundParameter period = (CompoundParameter) new CompoundParameter("Period", 1000, 500, 10000)
            .setExponent(2).setDescription("Period of oscillation of the stripe");

    public final CompoundParameter size = (CompoundParameter) new CompoundParameter("Size", 3 * JouleCode.FEET,
            1 * JouleCode.FEET, 10 * JouleCode.FEET).setDescription("Size of the stripe");
