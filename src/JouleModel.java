...
public class JouleModel extends LXModel {
  ...
  public JouleModel(LXFixture[] allFixtures, List<BeagleboneController> controllers, List<Cluster> clusters, List<GemType> gemTypes, List<Gem> gems) {
	  super(allFixtures);
  ...
  {	  
	  ...
	  // Read Gems from file but save them to create with their appropriate cluster, for transform convenience.
	  ...
	  return new JouleModel(_fixtures.toArray(new LXFixture[_fixtures.size()]), controllers, clusters, gemTypes, gems);	  
  }
